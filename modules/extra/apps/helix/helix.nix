    ...
    in
    {
      options.programs.helix =
        ...
        in
        {
          ...
          themes = mkOpt (types.attrsOf toml) { } "See <https://docs.helix-editor.com/themes.html>";

          defaultEditor = mkOpt types.bool true ''

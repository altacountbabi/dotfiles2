      ...
      }:
      {
        config = lib.mkIf cfg.enable {
          ...
          prefs.merged-configs = with config.prefs.user; {
            ...
            dms-session = {
              path = "${home}/.local/state/DankMaterialShell/session.json";
              overlay = cfg.session;
            };
          };
          ...
          programs.niri.settings.binds =
            {
              ...
              "Alt+8" = "dms ipc mpris playPause";
              "Alt+9" = "dms ipc mpris next";
              "Alt+0" = "dms ipc audio mute";
              "Alt+Minus" = "dms ipc audio increment 5";
              "Alt+Equal" = "dms ipc audio decrement 5";
              "XF86AudioMute" = "dms ipc audio mute";
              "XF86AudioLowerVolume" = "dms ipc audio increment 5";
              "XF86AudioRaiseVolume" = "dms ipc audio decrement 5";
            }
            |> lib.mapAttrs (
              _: v:
              lib.mkForce {

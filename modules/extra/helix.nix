  ...
  flake.nixosModules.helix =
    ...
    in
    {
      options.prefs = {
        ...
        helix.preferredEditor = mkDefaultEnableOption "set `EDITOR` environment variable to helix";

        helix.configureRoot = mkDefaultEnableOption "configure helix for root user";
